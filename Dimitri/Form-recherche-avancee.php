...
Date : <input type="date" name="dateEvenement" required="" value="<?php if (isset($_POST['dateEvenement'])){echo $_POST['dateEvenement'];} ?>"/><br/>
<br/>
...
Ville : <input type="text" name="ville" required="" value="<?php if (isset($_POST['ville'])){echo $_POST['ville'];} ?>" /><br/>
<br/>
...
<select name="pays" id="pays">
  ...
  <option value="Repas/Banquets">Repas/Banquets</option>
  <option value="Brocantes/Marchés">Brocantes/Marchés</option>
...
Cibles de l'événement (plusieurs réponses possibles) : <br/>
...
Gratuit? : <input type="checkbox" name="gratuit" checked required="" value="<?php if (isset($_POST['gratuit'])){echo $_POST['gratuit'];} ?>" /><br/>
<br/>

Organisateur(s) : <input type="text" name="organisateur" required="" value="<?php if (isset($_POST['organisateur'])){echo $_POST['organisateur'];} ?>" /><br/>
<br/>
