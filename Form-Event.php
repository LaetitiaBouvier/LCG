<form name="inscription" method="post" action="Create-Event.php" enctype="multiplart/form-data">
...
Nom de l'événement<em>*</em> : <input type="text" name="nom"/> <br/>  <br/>
...
Ajouter une photo pour l'événement<em>*</em> :  <input type="file" name="photo" id="photo-event" /><br /> <br />

Ajouter une vidéo pour l'événement :  <input type="file" name="video" id="video-event" /><br /> <br />

Catégorie de l'événement (1 seule réponse possible)<em>*</em> : <br/> <br/>

<input type="radio" name="categorie" value="Festivals" />Festivals<br/>
<input type="radio" name="categorie" value="Repas/Banquets" />Repas/Banquets<br/>
<input type="radio" name="categorie" value="Concerts" />Concerts<br/>
<input type="radio" name="categorie" value="Brocantes/Marchés" />Brocantes/Marchés<br/>
<input type="radio" name="categorie" value="Soirées" />Soirées<br/>
<input type="radio" name="categorie" value="Conférences" />Conférences<br/>
<input type="radio" name="categorie" value="Humanitaires" />Humanitaires<br/>
<input type="radio" name="categorie" value="Sportifs" />Sportifs<br/>
<input type="radio" name="categorie" value="Manifestations" />Manifestations<br/>
<br/>

Cibles de l'événement (plusieurs réponses possibles) <em>*</em>: <br/> </br>

<input type="checkbox" name="age1" value="Bas-âge"/>Bas-âge</br>
<input type="checkbox" name="age2" value="Enfants"/>Enfants</br>
<input type="checkbox" name="age3"value="Ados"/>Ados</br>
<input type="checkbox" name="age4" value="Adultes"/>Adultes</br>
<input type="checkbox" name="age5" value="Seniors"/>Seniors</br>
