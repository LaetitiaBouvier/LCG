...
<?php
  ...
  $req = $bdd->prepare('SELECT ID_Evenement, Nom_Evenement, Categorie_Evenement, JourDebut_Evenement, HeureDebut_Evenement, JourFin_Evenement, HeureFin_Evenement, AdressePostal_Evenement, Image_Evenement,Description_Evenement FROM evenement_table WHERE AdresseRegion_Evenement = "'.$_GET['REG'].'"');
  $req->execute();
